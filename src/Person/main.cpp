...
int main() {
 ...
 std::cout << "Copy\n";
 Person p5 {p1};
 cout << p5.getFirstName() << " " << p5.getLastName() << endl;

 // Assignment
 std::cout << "Assignment\n";
 auto p6 = p1;
 cout << p6.getFirstName() << " " << p6.getLastName() << endl;

 // Initials
 std::cout << "Initials\n";
 Person p7{"Amal", "Issa", "AI"};
 cout << p7.getFirstName() << " " << p7.getLastName() << " " <<p7.getInitials() << endl;
